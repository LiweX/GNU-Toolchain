...
lab3: lab3.o lib_static.a lib_dynamic.so
	gcc $(CFLAGS) -o lab3 lab3.o -L. lib_static.a lib_dynamic.so -ldl
...
lib_dynamic.so: filesystems.o myFuncs.o cJSON.o
	gcc filesystems.o myFuncs.o cJSON.o -shared -fPIC -o lib_dynamic.so 
